...
var settings = {
	...
	time_ul_max: 0, // max duration of upload test in seconds
	...
	time_ulGraceTime: 0, //time to wait in seconds before actually measuring ul speed (wait for buffers to fill)
